...
import com.orchords.orchordsai.di.appModule
...
private const val TAG = "OrchestrdsAIApp"

const val CHAT_COMPLETED_NOTIFICATION_CHANNEL_ID = "chat_completed"
const val CHAT_LIVE_UPDATE_NOTIFICATION_CHANNEL_ID = "chat_live_update"
const val WEB_SERVER_NOTIFICATION_CHANNEL_ID = "web_server"

class OrchestrdsAIApp : Application() {
    override fun onCreate() {
        super.onCreate()
        startKoin {
            androidLogger()
            androidContext(this@OrchestrdsAIApp)
            workManagerFactory()
        ...
        get<AppScope>().launch {
            runCatching {
                ...
                if (settings.webServerEnabled) {
                    ...
                    val intent = Intent(this@OrchestrdsAIApp, WebServerService::class.java).apply {
