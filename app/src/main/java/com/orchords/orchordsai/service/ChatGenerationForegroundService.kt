...
import com.orchords.orchordsai.OrchestrdsAiActivity
...
class ChatGenerationForegroundService : Service() {
    companion object {
        private const val ACTION_ACQUIRE = "com.orchords.orchordsai.action.CHAT_GENERATION_ACQUIRE"
        private const val ACTION_RELEASE = "com.orchords.orchordsai.action.CHAT_GENERATION_RELEASE"
    ...
    private fun buildNotification(conversationId: String) =
        NotificationCompat.Builder(this, CHAT_LIVE_UPDATE_NOTIFICATION_CHANNEL_ID)
            .setSmallIcon(R.drawable.ic_stat_orchordsai)
    ...
    private fun getConversationPendingIntent(conversationId: String): PendingIntent {
        val intent = Intent(this, OrchestrdsAiActivity::class.java).apply {
