...
import com.orchords.orchordsai.ui.context.LocalSharedTransitionScope
...
import com.orchords.orchordsai.ui.hooks.readBooleanPreference
import com.orchords.orchordsai.ui.hooks.readStringPreference
import com.orchords.orchordsai.ui.hooks.rememberCustomAsrState
import com.orchords.orchordsai.ui.hooks.rememberCustomTtsState
import com.orchords.orchordsai.ui.pages.assistant.AssistantPage
import com.orchords.orchordsai.ui.pages.assistant.detail.AssistantBasicPage
import com.orchords.orchordsai.ui.pages.assistant.detail.AssistantDetailPage
import com.orchords.orchordsai.ui.pages.assistant.detail.AssistantExtensionsPage
import com.orchords.orchordsai.ui.pages.assistant.detail.AssistantLocalToolPage
import com.orchords.orchordsai.ui.pages.assistant.detail.AssistantMcpPage
import com.orchords.orchordsai.ui.pages.assistant.detail.AssistantMemoryPage
import com.orchords.orchordsai.ui.pages.assistant.detail.AssistantPromptPage
import com.orchords.orchordsai.ui.pages.assistant.detail.AssistantRequestPage
import com.orchords.orchordsai.ui.pages.backup.BackupPage
import com.orchords.orchordsai.ui.pages.chat.ChatPage
import com.orchords.orchordsai.ui.pages.debug.DebugPage
import com.orchords.orchordsai.ui.pages.extensions.ExtensionsPage
import com.orchords.orchordsai.ui.pages.extensions.PromptPage
import com.orchords.orchordsai.ui.pages.extensions.QuickMessagesPage
import com.orchords.orchordsai.ui.pages.extensions.skills.SkillDetailPage
import com.orchords.orchordsai.ui.pages.extensions.skills.SkillsPage
import com.orchords.orchordsai.ui.pages.extensions.workspace.WorkspacePage
import com.orchords.orchordsai.ui.pages.extensions.workspace.WorkspaceDetailPage
import com.orchords.orchordsai.ui.pages.extensions.workspace.WorkspaceFileEditorPage
import com.orchords.orchordsai.ui.pages.extensions.workspace.WorkspaceTerminalPage
import com.orchords.workspace.WorkspaceStorageArea
import com.orchords.orchordsai.ui.pages.favorite.FavoritePage
import com.orchords.orchordsai.ui.pages.history.HistoryPage
import com.orchords.orchordsai.ui.pages.imggen.ImageGenPage
import com.orchords.orchordsai.ui.pages.log.LogPage
import com.orchords.orchordsai.ui.pages.search.SearchPage
import com.orchords.orchordsai.ui.pages.setting.SettingAboutPage
import com.orchords.orchordsai.ui.pages.setting.SettingPreferencesPage
import com.orchords.orchordsai.ui.pages.setting.SettingPreferencesThemePage
import com.orchords.orchordsai.ui.pages.setting.SettingPreferencesNotificationPage
import com.orchords.orchordsai.ui.pages.setting.SettingPreferencesGeneralPage
import com.orchords.orchordsai.ui.pages.setting.SettingPreferencesNetworkPage
import com.orchords.orchordsai.ui.pages.setting.SettingPreferencesUIPage
import com.orchords.orchordsai.ui.pages.setting.SettingThemePage
import com.orchords.orchordsai.ui.pages.setting.SettingFilesPage
import com.orchords.orchordsai.ui.pages.setting.SettingMcpPage
import com.orchords.orchordsai.ui.pages.setting.SettingModelPage
import com.orchords.orchordsai.ui.pages.setting.SettingPage
import com.orchords.orchordsai.ui.pages.setting.SettingProviderDetailPage
import com.orchords.orchordsai.ui.pages.setting.SettingProviderPage
import com.orchords.orchordsai.ui.pages.setting.SettingSearchDetailPage
import com.orchords.orchordsai.ui.pages.setting.SettingSearchPage
import com.orchords.orchordsai.ui.pages.setting.SettingSpeechPage
import com.orchords.orchordsai.ui.pages.setting.SettingWebPage
import com.orchords.orchordsai.ui.pages.share.handler.ShareHandlerPage
import com.orchords.orchordsai.ui.pages.stats.StatsPage
import com.orchords.orchordsai.ui.pages.translator.TranslatorPage
import com.orchords.orchordsai.ui.pages.webview.WebViewPage
import com.orchords.orchordsai.ui.theme.LocalDarkMode
import com.orchords.orchordsai.ui.theme.OrchestrdsAITheme
...
private const val TAG = "OrchestrdsAiActivity"

class OrchestrdsAiActivity : ComponentActivity() {
    ...
    fun AppRoutes() {
        ...
        LaunchedEffect(tts) {
            eventBus.events.collect { event ->
                when (event) {
                    ...
                    is AppEvent.OpenUsageAccessSettings -> this@OrchestrdsAiActivity.openUsageAccessSettings()
                    is AppEvent.ChatGenerationUpdate -> Unit // consumed by ChatNotificationManager
                    is AppEvent.ChatGenerationEnded -> Unit // consumed by ChatNotificationManager
                }
            }
        }
        ...
        SideEffect { this@OrchestrdsAiActivity.navStack = backStack }
