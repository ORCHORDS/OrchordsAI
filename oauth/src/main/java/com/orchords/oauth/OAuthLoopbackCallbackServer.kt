...
class OAuthLoopbackCallbackServer(
    ...
    private fun successHtml() = callbackPage(
        ...
        hint = localizedString(
            ...
            "You can close this tab and return to OrchestrdsAI.",
        ),
    )
    ...
    private fun errorHtml() = callbackPage(
        ...
        hint = localizedString(
            ...
            "Close this tab and try again from OrchestrdsAI.",
        ),
    )
    ...
    private fun invalidCallbackHtml() = callbackPage(
        ...
        hint = localizedString(
            ...
            "Return to OrchestrdsAI and start the authorization again.",
        ),
    )
    ...
    private fun callbackAlreadyHandledHtml() = callbackPage(
        ...
        hint = localizedString(
            ...
            "You can safely close this tab and return to OrchestrdsAI.",
        ),
    )
    ...
    private fun callbackPage(
        ...
        return """
            ...
            <head>
              ...
              <title>$safeTitle · OrchestrdsAI</title>
              <style>
                :root {
